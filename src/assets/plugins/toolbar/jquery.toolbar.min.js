    ...
    (function (a, b, c, d) {
        var e = {
            ...
            populateContent: function () {
                ...
                c.html(d),
                    c.find('.tool-item').on('click', function (a) {
                        a.preventDefault(),
                            b.$elem.trigger('toolbarItemClick', this);
                    });
            },
            ...
            collisionDetection: function () {
                var c = this,
                    d = 20;
                ('top' == c.options.position ||
                    'bottom' == c.options.position) &&
                    ((c.arrowCss = { left: '50%', right: '50%' }),
                    c.toolbarCss.left < d
                        ? ((c.toolbarCss.left = d),
                          (c.arrowCss.left =
                              c.$elem.offset().left + c.$elem.width() / 2 - d))
                        : a(b).width() - (c.toolbarCss.left + c.toolbarWidth) <
                              d &&
