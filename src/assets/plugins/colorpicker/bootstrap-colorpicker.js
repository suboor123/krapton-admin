        ...
        return /******/ (function (modules) {
            ...
            /******/ [
                            ...
                            [
                                {
                                    ...
                                    value: function api(fn) {
                                        ...
                                        if (
                                            !(result instanceof _color2.default)
                                        ) {
                            ...
                            [
                                {
                                    ...
                                    value: function replace(color) {
                                        ...
                                        format =
                                            ColorItem.sanitizeFormat(format);
                            ...
                            [
                                {
                                    ...
                                    value: function parse(color) {
                                        ...
                                        if (color instanceof HSVAColor) {
                                            ...
                                            color =
                                                ColorItem.sanitizeString(color);
                                        }
                        ...
                        _createClass(Palette, [
                            ...
                            },
                            {
                                ...
                                value: function getValue(name) {
                                    ...
                                    if (
                                        this.options.colors.hasOwnProperty(name)
                                    ) {
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    _jquery2.default.fn[plugin].constructor =
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    var _SliderHandler2 =
                        _interopRequireDefault(_SliderHandler);
                    ...
                    var _PickerHandler2 =
                        _interopRequireDefault(_PickerHandler);
                    ...
                    var Colorpicker = (function () {
                        ...
                        function Colorpicker(element, options) {
                             ...
                             * @type {ColorHandler}
                             */
                            this.colorHandler = new _ColorHandler2.default(
                                this
                            );
                            /**
                             * @type {SliderHandler}
                             */
                            this.sliderHandler = new _SliderHandler2.default(
                                this
                            );
                            /**
                             * @type {PopupHandler}
                             ...
                             * @type {PickerHandler}
                             */
                            this.pickerHandler = new _PickerHandler2.default(
                                this
                            );
                            /**
                             * @type {AddonHandler}
                             */
                            this.addonHandler = new _AddonHandler2.default(
                                this
                            );
                        ...
                        _createClass(Colorpicker, [
                            ...
                            },
                            {
                                ...
                                value: function initExtensions() {
                                    ...
                                    this.options.extensions.forEach(function (
                                        ext
                                    ) {
                        ...
                        _createClass(SliderHandler, [
                            {
                                ...
                                value: function defaultOnMove(top, left) {
                                    ...
                                    // Adjust the color
                                    if (slider.callLeft) {
                                        color[slider.callLeft].call(
                                            color,
                                            left / slider.maxLeft
                                        );
                                    }
                                    if (slider.callTop) {
                                        color[slider.callTop].call(
                                            color,
                                            top / slider.maxTop
                                        );
                                    }
                            ...
                            },
                            {
                                ...
                                value: function bind() {
                                    ...
                                    for (var sliderName in sliders) {
                                        if (
                                            !sliders.hasOwnProperty(sliderName)
                                        ) {
                                            continue;
                                        }
                        ...
                        _createClass(ColorHandler, [
                            ...
                            },
                            {
                                ...
                                value: function isAlphaEnabled() {
                                    return (
                                        this.colorpicker.options.useAlpha !==
                                        false
                                    );
                                },
                        ...
                        _createClass(PickerHandler, [
                            ...
                            },
                            {
                                ...
                                value: function attach() {
                                    ...
                                    var pickerParent = this.colorpicker
                                        .container
