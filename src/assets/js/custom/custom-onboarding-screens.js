...
$(document).ready(function () {
    ...
    if ($('#onboardingScreens .onboard-screen').length) {
        $('#onboardingScreens .onboard-screen').slick({
            ...
            slidesToScroll: 1,
            prevArrow:
                '<button type="button" class="slick-prev btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>Previous</button>',
            nextArrow:
                '<button type="button" class="slick-next btn btn-primary">Next<i class="feather icon-arrow-right ml-2"></i></button>',
        });
