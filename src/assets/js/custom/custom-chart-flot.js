...
$(document).ready(function () {
    /* -- Flot - Real-Time Updates Chart -- */
    var realTimedata = [],
        totalPoints = 300;
    function getRandomData() {
        if (realTimedata.length > 0) realTimedata = realTimedata.slice(1);
    ...
    var options = {
        ...
        xaxes: [{ mode: 'time', font: { color: '#8A98AC' } }],
        yaxes: [
            { min: 0, font: { color: '#8A98AC' } },
            {
                position: 'right',
                font: { color: '#8A98AC' },
    ...
    $.plot('#flot-canvas', canvasData, options);
    /* -----  Flot - Thresholds Chart  ----- */
    var thresholdsData1 = [];
    for (var i = 0; i <= 60; i += 1) {
        thresholdsData1.push([i, parseInt(Math.random() * 30 - 10)]);
    }
    $.plot('#flot-thresholds', [
        {
            data: thresholdsData1,
    ...
    $.plot($('#flot-percentiles'), percentileDataset, {
        xaxis: {
            tickDecimals: 0,
            font: { color: '#8A98AC' },
        },
    ...
    $.plot('#flot-category', [categoriesData], {
        series: {
            bars: {
                show: true,
                barWidth: 0.5,
    ...
    for (var i = 0; i <= 10; i += 1) {
        stackingData1.push([i, parseInt(Math.random() * 30)]);
    }
    var stackingData2 = [];
    for (var i = 0; i <= 10; i += 1) {
        stackingData2.push([i, parseInt(Math.random() * 30)]);
    }
    var stackingData3 = [];
    for (var i = 0; i <= 10; i += 1) {
        stackingData3.push([i, parseInt(Math.random() * 30)]);
    }
    var stack = 0,
        bars = false,
        lines = true,
        steps = false;
    $.plot('#flot-stacking', [stackingData1, stackingData2, stackingData3], {
        series: {
            stack: stack,
            lines: {
                show: lines,
    ...
    var errorData1_points = {
        show: true,
        radius: 5,
        fillColor: 'rgba(255,63,63,0.3)',
        errorbars: 'xy',
    ...
    var errorData4_errors = [0.1, 0.4, 0.2];
    for (var i = 0; i < errorData4.length; i++) {
        errorData4_errors[i] = errorData4[i].concat(errorData4_errors[i]);
    }
    var errorData = [
        {
            color: '#0080ff',
            points: errorData1_points,
            data: errorData1,
            label: 'Series A',
        },
        {
            color: '#ff3f3f',
            points: errorData2_points,
            data: errorData2,
            label: 'Series B',
        },
        {
        ...
        },
        {
            color: '#d4d8de',
            points: errorData3_points,
            data: errorData4_errors,
        },
    ];
    $.plot($('#flot-errorbar'), errorData, {
        legend: {
            position: 'sw',
            show: true,
        },
    ...
    $.plot('#flot-donut-chart', donutData, {
        series: {
            pie: {
                innerRadius: 0.75,
                show: true,
