...
$(document).ready(function () {
    ...
    var lineDiffPointID = document
        .getElementById('chartjs-line-diff-size-point')
        .getContext('2d');
    ...
    var linechartID = document
        .getElementById('chartjs-basic-line')
        .getContext('2d');
    ...
    var lineSteppedID = document
        .getElementById('chartjs-line-stepped')
        .getContext('2d');
    ...
    var scatterChartID = document
        .getElementById('chartjs-scatter-chart')
        .getContext('2d');
    ...
    var linePointID = document
        .getElementById('chartjs-line-point')
        .getContext('2d');
    ...
    /* -- Chartjs - Bar Chart -- */
    var barChartID = document
        .getElementById('chartjs-bar-chart')
        .getContext('2d');
    ...
    var horiBarChartID = document
        .getElementById('chartjs-horizontal-bar-chart')
        .getContext('2d');
    ...
    var multiAxisBarChartID = document
        .getElementById('chartjs-multi-axis-bar-chart')
        .getContext('2d');
    ...
    var stackedBarChartID = document
        .getElementById('chartjs-stacked-bar-chart')
        .getContext('2d');
    ...
    var lineBarMixedID = document
        .getElementById('chartjs-line-bar-mixed-chart')
        .getContext('2d');
    ...
    var boundaryAreaID = document
        .getElementById('chartjs-boundary-area-chart')
        .getContext('2d');
            ...
            datasets: [
                {
                    ...
                    pointBorderWidth: 2,
                    data: [
                        6.06, 82.2, -22.11, 21.53, -21.47, 73.61, -53.75,
                        -60.32,
                    ],
                    label: 'Series A',
                    fill: 'start',
    ...
    var datasetAreaID = document
        .getElementById('chartjs-dataset-area-chart')
        .getContext('2d');
    ...
    var stackedAreaID = document
        .getElementById('chartjs-stacked-area-chart')
        .getContext('2d');
    ...
    var radarAreaID = document
        .getElementById('chartjs-radar-area-chart')
        .getContext('2d');
            ...
            datasets: [
                {
                    ...
                    pointBorderWidth: 1,
                    data: [
                        21.9, 21.67, 18.5, 18.77, 19.62, 19.68, 19.93, 21.95,
                    ],
                    label: 'D0',
                },
                {
                    ...
                    pointBorderWidth: 1,
                    data: [
                        36.32, 43.93, 32.54, 33.54, 42.82, 39.34, 35.84, 33.5,
                    ],
                    hidden: true,
                    label: 'D1',
                    fill: '-1',
                ...
                },
                {
                    ...
                    pointBorderWidth: 1,
                    data: [
                        47.7, 58.92, 44.45, 49.08, 53.39, 51.85, 48.4, 49.36,
                    ],
                    label: 'D3',
                    fill: false,
                },
                {
                    ...
                    pointBorderWidth: 1,
                    data: [
                        60.73, 71.97, 53.96, 57.22, 65.09, 62.06, 56.9, 60.52,
                    ],
                    label: 'D4',
                    fill: '-1',
                },
                {
                    ...
                    pointBorderWidth: 1,
                    data: [
                        73.33, 80.78, 68.05, 68.59, 76.79, 77.24, 66.08, 72.37,
                    ],
                    label: 'D5',
                    fill: '-1',
                },
    ...
    /* -- Chartjs - Radar Chart -- */
    var radarChartID = document
        .getElementById('chartjs-radar-chart')
        .getContext('2d');
    ...
    var polarAreaChartID = document
        .getElementById('chartjs-polar-area-chart')
        .getContext('2d');
    ...
    var bubbleChartID = document
        .getElementById('chartjs-bubble-chart')
        .getContext('2d');
