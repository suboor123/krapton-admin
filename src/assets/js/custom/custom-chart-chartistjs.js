...
$(document).ready(function () {
    ...
    var chart = new Chartist.Line(
        '#chartist-advanced-smil-animations',
        {
            labels: [
                '1',
                '2',
    ...
    var chart = new Chartist.Line(
        '#chartist-line-interpolation-smoothing',
        {
            labels: [1, 2, 3, 4, 5],
            series: [
                [1, 5, 10, 0, 1],
    ...
    new Chartist.Bar(
        '#chartist-overlapping-bars-on-moblie',
        data,
        options,
        responsiveOptions
    );
    ...
    new Chartist.Bar(
        '#chartist-extreme-responsive-configuration',
        {
    ...
    new Chartist.Pie(
        '#chartist-gauge-fill-rather-chart',
        {
            series: [45, 35, 20],
        },
        {
    ...
    var chart = new Chartist.Pie(
        '#chartist-animating-donut-with-svg-animate',
        {
    ...
    new Chartist.Pie(
        '#chartist-donut-fill-rather-chart',
        {
            series: [45, 35, 20],
        },
        {
